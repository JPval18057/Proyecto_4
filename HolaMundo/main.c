...
unsigned char   estado_boton1 = 0;
unsigned char   estado_boton2 = 0;
unsigned char   estado_boton3 = 0;
unsigned char   estado_boton4 = 0;
   ...
   while (1)
    {
       ...
       estado_boton3 = boton1==GPIO_PIN_0;
...
void parking_update(void){
    ...
    UARTCharPut(UART0_BASE, estado_boton1); //1
    UARTCharPut(UART0_BASE, estado_boton2); //2
    UARTCharPut(UART0_BASE, estado_boton3); //3
    UARTCharPut(UART0_BASE, estado_boton4); //4
    UARTCharPut(UART0_BASE, espacio_disponible); //5
